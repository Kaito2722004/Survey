  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container py-8">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 [&>div]:flex [&>div]:flex-col [&>div]:min-h-0">
          ...
          <div className="card-elevated p-6">
            <h3 className="text-lg font-semibold">5) Create Survey</h3>
            <p className="mt-2 flex-1 text-sm text-muted-foreground">
          ...
          <div className="card-elevated p-6">
            <h3 className="text-lg font-semibold">6) View Surveys</h3>
            <p className="mt-2 flex-1 text-sm text-muted-foreground">
